...
public class RoundedLetterView extends View {
    ...
    private static final float DEFAULT_ROUNDING = .5f;
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mBackgroundColor = a.getColor(R.styleable.RoundedLetterView_rlv_backgroundColor, DEFAULT_BACKGROUND_COLOR);
        mTitleSize = a.getDimension(R.styleable.RoundedLetterView_rlv_titleSize, DEFAULT_TITLE_SIZE);
        mRounding = a.getFloat(R.styleable.RoundedLetterView_rlv_round, DEFAULT_ROUNDING);
        a.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // drawing
        int rounding = Math.round(mRounding * mViewSize);
        canvas.drawRoundRect(mInnerRectF, rounding, rounding, mBackgroundPaint);
    ...
    /**
     * Set Rounding between 0 to 0.5
     * 0 = Rectangle
     * 0.08 = Rounded Rectangle by 4 % of size
     * 0.5 = Circle
     * @param rounding float value between 0 to 0.5f
     */
